...
function get_press_article($ident)
{
    if (DATABASE_TYPE === "json") {
        ...
        if (SPA_MODE){
        $q = "SELECT a.*,a.image_art AS id_image,  a.id_art AS id, a.title_art AS title, a.readtime_art AS temps_lecture, a.date_art AS date_creation, r.name_rep AS auteur, c.name_cat AS categorie 
                FROM t_article a 
